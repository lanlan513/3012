    ...
    >
      ...
      <div className="relative aspect-[5/3] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, transparent 30%, rgba(51, 37, 21, 0.4) 100%)',
          }}
        />
        {/* Date badge */}
      ...
      <div className="relative p-6">
        <h3 className="font-serif text-lg text-ink-700 font-semibold mb-2 group-hover:text-gold-700 transition-colors duration-300">
          {event.title}
        </h3>

        {/* Location */}
        <p className="font-body text-paper-600 text-sm mb-4 flex items-center gap-1.5">
        ...
        {/* Quote */}
        <p className="font-body text-paper-700 text-sm italic line-clamp-2 leading-relaxed">
          {event.quote}
        </p>
